...
?>
    ...
    <main class="kontakt seccion contenedor">
        <h1 class="kontakt__heading">Datenschutzerklärung</h1>

            <div class="kontakt__contenido">
                <p><strong>Allgemeiner Hinweis und Pflichtinformationen</strong></p>
                <p><strong>Benennung der verantwortlichen Stelle</strong></p>
                <p>Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:</p>
                <p><span id="s3-t-firma">der Spanier</span><br><span id="s3-t-ansprechpartner">Bernardo Gomez</span><br><span id="s3-t-strasse">Jöllenbecker Strasse 57</span><br><span id="s3-t-plz">33613</span> <span id="s3-t-ort">Bielefeld</span></p><p></p>
                ...
                <p>Als Betroffener steht Ihnen im Falle eines datenschutzrechtlichen Verstoßes ein Beschwerderecht bei der zuständigen Aufsichtsbehörde zu. Zuständige Aufsichtsbehörde bezüglich datenschutzrechtlicher Fragen ist der Landesdatenschutzbeauftragte des Bundeslandes, in dem sich der Sitz unseres Unternehmens befindet. Der folgende Link stellt eine Liste der Datenschutzbeauftragten sowie deren Kontaktdaten bereit: <a href="https://www.bfdi.bund.de/DE/Infothek/Anschriften_Links/anschriften_links-node.php" target="_blank">https://www.bfdi.bund.de/DE/Infothek/Anschriften_Links/anschriften_links-node.php</a>.</p>
